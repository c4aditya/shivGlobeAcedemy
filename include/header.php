...
<head>
    ...
    <title>SHIVGLOBE AI AND AVIATION ACADEMY (OPC) PRIVATE LIMITED</title>
    <link rel="stylesheet"
                                    ...
                                    <li>
                                        ...
                                        <a href="tel:+919211018618">
                                            <span class="color-secondary">Email: </span> <span><span
                                                    class="__cf_email__"
                                                    data-cfemail="67300614130e06275008150808014904080a">[&#160; info@ghghdagdshashivglobcademy.com]</span></span>
                                        </a>
                                    </li>
                                    <li>
            ...
            <nav class="navbar navbar-expand-lg sticky-navbar">
                <div class="container-fluid">
                    <a class="navbar-brand" href="index.php">
                        <img src="assets/images/logo/logo.png" width="200" height="80" alt="logo">
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="mainNavigation">
                        ...
                        <ul class="header-actions d-flex align-items-center position-relative list-unstyled mb-0">
                            <li>
                                <button class="action-btn-search"><i class="icon-search"></i></button>
                            </li>
                    ...
                    <div class="contact-area d-none d-xl-flex align-items-center h-100 ml-30">
                        <a href="#" class="btn btn-white btn-contact mr-20">Request Pickup</a>
                        <a class="contact-phone d-flex align-items-center" href="tel:00201061245741">
                            ...
                            <div>
                                ...
                                <span class="phone-number d-block">+91 9211018618</span>
                            </div>
                        </a>
                    </div>
                </div><!-- /.container -->
