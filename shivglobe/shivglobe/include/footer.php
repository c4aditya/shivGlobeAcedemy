                 ...
                 <div class="col-12 col-lg-3">
                     <div class="footer-widget-about">
                         ...
                         <p class="footer-widget-desc color-gray-400">
                             ShivGlobe Academy Private Limited is a leading international skill development and career
                             training
                     ...
                     <div class="footer-widget-nav">
                         ...
                         <nav>
                             <ul class="list-unstyled">
                                 ...
                                 <li><a href="#">Accounting Basics</a></li>
                                 <li><a href="#">PHP, Python, Java Basics</a></li>
                                 <li><a href="#">HTML, CSS, JavaScript</a></li>
                                 <li><a href="#">Digital Marketing</a></li>
                                 <li><a href="#">Design Systems Summit</a></li>
                             </ul>
                         </nav>
                     </div><!-- /.footer-widget-content -->
                 </div><!-- /.col-lg-2 -->
                     ...
                     <div class="footer-widget-nav">
                         ...
                         <nav>
                             <ul class="list-unstyled">
                                 ...
                                 <li><a href="#">More free resources</a></li>
                             ...
                             <li>
                                 <a href="">
                                     <i class="contact-icon icon-email"></i> <span><span class="__cf_email__"
                                             data-cfemail="a1f6c0d2d5c8c0e196ced3cecec78fc2cecc">[email&#160;protected]</span></span>
                                 </a>
                             </li>
                             <li>
                                 <a href="tel:00201061245741">
                                     <i class="contact-icon icon-phone"></i> <span>+2 01161145741</span>
                                 </a>
                             </li>
                             <li>
                                 <a class="contact-address" href="https://www.google.com/maps">2307 Beverley Rd
                                     Brooklyn, New York 11226 United States.</a>
                             </li>
                         </ul>
                     </div>
                 </div><!-- /.col-lg-3 -->
             ...
             <div class="row">
                 <div class="col-12 d-flex justify-content-between align-items-center">
                     ...
                     <div class="copyright-text" style="margin-top: 12px;">
                         <span>&copy; 2025 ShivGlobe Academy Private Limited. All Rights Reserved.</span>
                     </div>
